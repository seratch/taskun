...
public class TaskunSchedulerTest extends TestCase {
	...
	public void test_initialize_A$ComponentContainerAdaptor() throws Exception {
		scheduler.initialize(container);
	}
	...
	public void test_invokeCronDaemon_A$ComponentContainerAdaptor$ScheduledExecutorService()
			throws Exception {
